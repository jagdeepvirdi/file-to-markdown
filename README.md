...
└── frontend/
    ...
    ├── app.v4.js           # Drag/drop, native file selection, API calls, log history
...
- **Cache busting.** WebView2 caches aggressively. CSS/JS files use versioned names (`style.v2.css`, `app.v4.js`). Bump the version suffix when making breaking frontend changes.
